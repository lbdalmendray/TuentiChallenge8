...
public static class Utils
{
    ...
    public static bool SolveDiophanLinearEquation(Number a1, Number a2, Number independent, out Door door1, out Door door2)
    {
        ...
        Number cocient = Math.Abs(independent / gcd);
        a1Sol *= cocient;
        a2Sol *= cocient;

        //door1 = new Door { Period = Math.Abs(a2)  / gcd, Independent = -a1Sol*(Math.Sign(a1)) };
        //door2 = new Door { Period = -Math.Abs(a1)  / gcd, Independent = -a2Sol*(Math.Sign(a2)) };
